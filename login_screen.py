...
from SRVBank.screens.camera_test import camTest
...
class LoginScreen(Screen):
    def __init__(self, **kwargs):
        ...
        #############################
        #  얼굴인증 촬영 테스트 버튼
        self.second_verification_button = ImageButton(source='images/profile_picture.png', size_hint=(0.9, 0.1), pos_hint={'x':0.07, 'y':0.1})
    ...
    def test_verification(self, instance):
        self.manager.current = 'secondVerification'#''camtest
